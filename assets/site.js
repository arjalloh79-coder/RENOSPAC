...
const I18N = {
  fr: {
    ...
    nav_gallery:"Galerie", nav_contact:"Contact", nav_cta:"Nous rejoindre", back_btn:"← Retour",
    hero_welcome:"Bienvenue sur le site officiel du RENOSPAC",
    ad_slot_label:"Faites de la publicité ici", ad_slot_sub:"Touchez un vaste réseau de structures sanitaires à travers toute la Guinée — contactez-nous →",
    ...
    hero_lead:`Un vaste réseau de <strong class="text-white">structures sanitaires</strong> réunies à travers <strong class="text-white">9 plateformes nationales</strong>, aux côtés du Ministère de la Santé et de l'Hygiène Publique.`,
    ...
    about_p1:`Le <strong>Réseau National des Organisations Sanitaires Privées, Associatives et Confessionnelles de Guinée (RENOSPAC)</strong> est une organisation regroupant et représentant <strong>un vaste réseau de structures sanitaires privées</strong> en Guinée à travers neuf plateformes nationales.`,
    ...
    president_teaser:"« Le RENOSPAC s'engage chaque jour aux côtés de ses nombreuses structures membres pour un secteur sanitaire privé plus fort, plus éthique et plus utile à la population guinéenne. »",
...
<p class="mt-5 text-petrol-700 leading-relaxed italic">Avec foi et détermination,</p>`,
    ...
    value2_t:"Solidarité", value2_d:"L'union de nombreuses structures et de 9 plateformes au service d'un même engagement.",
    ...
    news_a1_title:"RENOSPAC : une seule coordination pour les structures sanitaires privées de tout le pays",
    ...
    footer_bio:"Réseau National des Organisations Sanitaires Privées, Associatives et Confessionnelles de Guinée. Un vaste réseau de structures sanitaires réunies au service de la santé de la population guinéenne, en partenariat avec le Ministère de la Santé et de l'Hygiène Publique via la DNEHPP.",
  ...
  en: {
    ...
    nav_gallery:"Gallery", nav_contact:"Contact", nav_cta:"Join us", back_btn:"← Back",
    hero_welcome:"Welcome to the official RENOSPAC website",
    ad_slot_label:"Advertise here", ad_slot_sub:"Reach a nationwide network of health facilities across Guinea — contact us →",
    ...
    hero_lead:`A nationwide network of <strong class="text-white">health facilities</strong> united through <strong class="text-white">9 national platforms</strong>, alongside the Ministry of Health and Public Hygiene.`,
    ...
    about_p1:`The <strong>National Network of Private, Associative and Faith-Based Health Organisations of Guinea (RENOSPAC)</strong> is an organisation bringing together and representing <strong>a nationwide network of private health facilities</strong> in Guinea through nine national platforms.`,
    ...
    president_teaser:"“RENOSPAC works every day alongside its many member facilities for a stronger, more ethical private health sector that better serves the Guinean population.”",
...
<p class="mt-5 text-petrol-700 leading-relaxed italic">With faith and determination,</p>`,
    ...
    value2_t:"Solidarity", value2_d:"The union of many facilities and 9 platforms behind a single commitment.",
    ...
    news_a1_title:"RENOSPAC: one coordination body for the country's private health facilities",
    ...
    footer_bio:"National Network of Private, Associative and Faith-Based Health Organisations of Guinea. A nationwide network of health facilities united to serve the health of the Guinean population, in partnership with the Ministry of Health and Public Hygiene through the DNEHPP.",

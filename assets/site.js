...
const I18N = {
  fr: {
    ...
    ad_slot_label:"Faites de la publicité ici", ad_slot_sub:"Rejoignez notre réseau de santé privée en Guinée — contactez-nous →",
    ...
    hero_lead:`De nombreuses <strong class="text-white">structures sanitaires</strong> réunies à travers <strong class="text-white">9 plateformes nationales</strong>, aux côtés du Ministère de la Santé et de l'Hygiène Publique.`,
    ...
    president_teaser:"« Le RENOSPAC s'engage chaque jour aux côtés de ses structures membres pour un secteur sanitaire privé plus fort, plus éthique et plus utile à la population guinéenne. »",
...
<p class="mt-5 text-petrol-700 leading-relaxed italic">Avec foi et détermination,</p>`,
    ...
    value2_t:"Solidarité", value2_d:"L'union de nombreuses structures et 9 plateformes au service d'un même engagement.",
    ...
    news_a1_title:"RENOSPAC : une seule coordination pour un important réseau de structures sanitaires privées",
  ...
  en: {
    ...
    ad_slot_label:"Advertise here", ad_slot_sub:"Join our private health network in Guinea — contact us →",
    ...
    hero_lead:`Numerous <strong class="text-white">health facilities</strong> united through <strong class="text-white">9 national platforms</strong>, alongside the Ministry of Health and Public Hygiene.`,
    ...
    about_p1:`The <strong>National Network of Private, Associative and Faith-Based Health Organisations of Guinea (RENOSPAC)</strong> is an organisation bringing together and representing <strong>a vast network of private health facilities</strong> in Guinea through nine national platforms.`,
    ...
    president_teaser:””RENOSPAC works every day alongside its member facilities for a stronger, more ethical private health sector that better serves the Guinean population.””,
...
<p class="mt-5 text-petrol-700 leading-relaxed italic">With faith and determination,</p>`,
    ...
    news_a1_title:"RENOSPAC: one coordination body for a significant network of private health facilities",
    ...
    footer_bio:"National Network of Private, Associative and Faith-Based Health Organisations of Guinea. A vast network of health facilities united to serve the health of the Guinean population, in partnership with the Ministry of Health and Public Hygiene through the DNEHPP.",

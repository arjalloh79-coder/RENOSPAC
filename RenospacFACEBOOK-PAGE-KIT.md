# Kit page Facebook — RENOSPAC Guinée

Tout est prêt à copier-coller. La création prend ~5 minutes.

## Étapes de création

1. Connectez-vous à Facebook → facebook.com/pages/create
2. **Nom de la Page** : `RENOSPAC Guinée`
3. **Catégorie** : `Organisation à but non lucratif` (ajoutez aussi `Service de santé`)
4. Collez la **bio** et la description ci-dessous, ajoutez les coordonnées, puis les images.
5. Nom d'utilisateur suggéré : `@renospacguinee` (donne l'adresse facebook.com/renospacguinee)

## Bio (155 caractères max)

> Réseau National des Organisations Sanitaires Privées, Associatives et Confessionnelles de Guinée — un réseau national de structures sanitaires, 9 plateformes, aux côtés du MSHP.
...
>
> Nous accompagnons le Ministère de la Santé et de l'Hygiène Publique, à travers la DNEHPP, dans la mise en œuvre de la stratégie nationale de développement sanitaire privé en Guinée : partenariat public–privé, coordination et suivi des structures, formation continue du personnel, appui aux promoteurs dans la recherche d'agréments.
...
> Le Réseau National des Organisations Sanitaires Privées, Associatives et Confessionnelles de Guinée fédère un vaste réseau de structures sanitaires à travers 9 plateformes nationales.
...
**Post 2 — Nos plateformes** *(avec la photo des gilets, photo-3)*
> 🤝 Le RENOSPAC, c'est l'union de 9 plateformes nationales : FNCPG · ONAMEL · ACS · SDT · AHP · IMG · ACMEG · RECOSAC-G · OCPH.
> Une seule coordination pour représenter les formations sanitaires privées, associatives et confessionnelles sur toute l'étendue du territoire national.
> #SantéPrivée #PartenariatPublicPrivé

**Post 3 — Accompagnement** *(avec photo-2 ou photo-7)*
> 📋 Vous êtes promoteur d'une structure sanitaire privée, associative ou confessionnelle ?
